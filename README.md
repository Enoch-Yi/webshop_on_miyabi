...
qsub -q regular-g -W group_list=gq50 -v SEED=42 tools/qsub_grpo.sh

# Full method, seed 42
qsub -q regular-g -W group_list=gq50 -v SEED=42 tools/qsub_full.sh

# 消融: Branch PG only (w_dpo=0)
qsub -q regular-g -W group_list=gq50 -v SEED=42,W_DPO=0.0 tools/qsub_full.sh

# 消融: Random state selection
qsub -q regular-g -W group_list=gq50 -v SEED=42,STATE_SEL=random tools/qsub_full.sh

# 消融: Random action pair
qsub -q regular-g -W group_list=gq50 -v SEED=42,ACTION_PAIR=random tools/qsub_full.sh
```
